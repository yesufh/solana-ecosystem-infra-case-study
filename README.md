...
<img src="assets/trump_tweets_coin.png" width="500">
<br>
<img src="assets/trump_coin_fud.png" width="500">
<br>
<img src="assets/trump_coin_sentiment.png" width="500">

***

**The Infrastructure Pivot (Piotrostr, Listen & ARC)**
Moving away from manual sentiment-trading, I began researching the "plumbing" of the network. I focused on **Piotrostr (Piotrek)**, a lead engineer in the DeFAI (Decentralized AI Finance) space whose work is industry-leading. I aligned my portfolio with the infrastructure-side by holding **$LISTEN** and **$ARC** (AI Rig Complex). Studying Piotrek's GitHub—specifically the `listen-rs` framework—showed me how Rust-based agents can manage on-chain liquidity. This moved my focus from "trading tickers" to "analyzing systems."

<img src="assets/listen_and_arc_holdings.png" width="500">
...
<img src="assets/peak_portfolio_100k.png" width="500">
...
<img src="assets/sol_the_trophy_tomato.png" width="500">
